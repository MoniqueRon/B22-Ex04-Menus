...
{
    public class MenuItem : IExecutableItem
    {
        ...
        public IExecutableItem ExecutableItem
        {
            get { return m_ExecutableItem; }
        }
        ...
        public MenuItem(string i_Title, IExecutableItem i_ExecutableItem, bool i_IsMainMenu)
        {
            m_Title = i_Title;
            m_Items = new List<MenuItem>();
            m_ExecutableItem = i_ExecutableItem;
            m_IsMainMenu = i_IsMainMenu;
        }
        ...
        private void displayUserChoise(int i_UserChoise)
        {
            ...
            {
                m_Items[i_UserChoise].ExecutableItem.Execute();
            }
